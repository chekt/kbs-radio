...
const url = 'https://onair.kbs.co.kr/index.html?sname=onair&ch_type=radioList&stype=live&ch_code=24'
https.get(url, (resp) => {
  let data = ''
  resp.on('data', (chunk) => {
    data += chunk;
